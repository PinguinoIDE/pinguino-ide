...
class Ui_PinguinoIDE(object):
    def setupUi(self, PinguinoIDE):
        ...
        self.actionTools = QtGui.QAction(PinguinoIDE)
        self.actionTools.setCheckable(True)
        self.actionTools.setChecked(True)
        self.actionTools.setObjectName("actionTools")
        self.actionShell = QtGui.QAction(PinguinoIDE)
        self.actionShell.setCheckable(True)
        self.actionShell.setChecked(True)
        self.actionShell.setObjectName("actionShell")
        self.actionBlocks = QtGui.QAction(PinguinoIDE)
