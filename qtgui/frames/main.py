...
class Ui_PinguinoIDE(object):
    def setupUi(self, PinguinoIDE):
        ...
        self.label = QtGui.QLabel(self.SearchReplace)
        ...
        self.label_search_block = QtGui.QLabel(self.dockWidgetContents)
        self.label_search_block.setObjectName("label_search_block")
        self.horizontalLayout_3.addWidget(self.label_search_block)
        self.lineEdit_blocks_search = QtGui.QLineEdit(self.dockWidgetContents)
        ...
        self.tabWidget_blocks = QtGui.QTabWidget(self.dockWidgetContents)
        ...
        self.dockWidget_right.setWidget(self.dockWidgetContents)
        ...
        self.dockWidget_bottom.setWidget(self.dockWidgetContents_3)
    ...
    def retranslateUi(self, PinguinoIDE):
        ...
        self.label.setText(QtGui.QApplication.translate("PinguinoIDE", "Search:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtGui.QApplication.translate("PinguinoIDE", "Python Shell", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("PinguinoIDE", "Log", None, QtGui.QApplication.UnicodeUTF8))
