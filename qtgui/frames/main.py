...
class Ui_PinguinoIDE(object):
    def setupUi(self, PinguinoIDE):
        ...
        self.menuEdt = QtGui.QMenu(self.menubar)
...
"font: 10pt \"Ubuntu Mono\";")
        ...
        self.menuEdt.addAction(self.actionUndo)
        self.menuEdt.addAction(self.actionRedo)
        self.menuEdt.addSeparator()
        self.menuEdt.addAction(self.actionCut)
        self.menuEdt.addAction(self.actionCopy)
        self.menuEdt.addAction(self.actionPaste)
        self.menuEdt.addSeparator()
        self.menuEdt.addAction(self.actionSearch)
        self.menuEdt.addAction(self.actionSearch_and_replace)
        self.menuEdt.addSeparator()
        self.menuEdt.addAction(self.actionSettings)
    ...
    def retranslateUi(self, PinguinoIDE):
        ...
        self.menuEdt.setTitle(QtGui.QApplication.translate("PinguinoIDE", "Edit", None, QtGui.QApplication.UnicodeUTF8))
