...
class Ui_PinguinoIDE(object):
    def setupUi(self, PinguinoIDE):
        ...
        self.Projects = QtGui.QWidget()
        self.Projects.setObjectName("Projects")
        self.gridLayout_16 = QtGui.QGridLayout(self.Projects)
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.treeWidget_projects = QtGui.QTreeWidget(self.Projects)
        ...
        self.treeWidget_projects.setColumnCount(3)
        ...
        self.gridLayout_16.addWidget(self.treeWidget_projects, 0, 0, 1, 1)
        self.tabWidget_tools.addTab(self.Projects, "")
    ...
    def retranslateUi(self, PinguinoIDE):
        ...
        self.treeWidget_projects.setSortingEnabled(True)
        self.treeWidget_projects.headerItem().setText(0, QtGui.QApplication.translate("PinguinoIDE", "File", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget_projects.headerItem().setText(1, QtGui.QApplication.translate("PinguinoIDE", "Compile as", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget_projects.headerItem().setText(2, QtGui.QApplication.translate("PinguinoIDE", "Preprocess as", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget_tools.setTabText(self.tabWidget_tools.indexOf(self.Projects), QtGui.QApplication.translate("PinguinoIDE", "Projects", None, QtGui.QApplication.UnicodeUTF8))
