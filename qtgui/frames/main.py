...
class Ui_PinguinoIDE(object):
    ...
    def retranslateUi(self, PinguinoIDE):
        ...
        self.tabWidget_bottom.setTabText(self.tabWidget_bottom.indexOf(self.tab), QtGui.QApplication.translate("PinguinoIDE", "Python Shell", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget_bottom.setTabText(self.tabWidget_bottom.indexOf(self.tab_2), QtGui.QApplication.translate("PinguinoIDE", "Log", None, QtGui.QApplication.UnicodeUTF8))
