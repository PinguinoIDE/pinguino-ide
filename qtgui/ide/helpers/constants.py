...
IDE_CONFIGLIBS_FILE = os.path.join(IDE_HOME_DIR, "qtgui", "config", "config_libs.conf")
...
IDE_LIBRARY_INSTALLED = os.path.join(os.path.dirname(IDE_HOME_DIR), "pinguino-libraries")
