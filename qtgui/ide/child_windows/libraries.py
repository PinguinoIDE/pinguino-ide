...
class LibManager(QtGui.QMainWindow):
    ...
    def __init__(self, IDE):
        ...
        self.connect(self.libframe.pushButton_reload_l, QtCore.SIGNAL("clicked()"), self.update_libraries_view)
        self.connect(self.libframe.pushButton_reload_s, QtCore.SIGNAL("clicked()"), self.update_sources_view)
