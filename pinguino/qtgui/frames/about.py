...
"the Free Software Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA")
    ...
    def retranslateUi(self, About):
        About.setWindowTitle(QtWidgets.QApplication.translate("About", "About...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_3.setText(QtWidgets.QApplication.translate("About", "<html><head/><body><p align=\"center\">Pinguino is an Open Software and Open Hardware<br>Arduino-like project. Boards are based on 8 or 32-bit USB built-in<br>Microchip microcontrollers. The main goal is to build a real<br>USB system without USB to serial converter.</p></body></html>", None, QtWidgets.QApplication.UnicodeUTF8))
        self.pushButton_credits.setText(QtWidgets.QApplication.translate("About", "Credits", None, QtWidgets.QApplication.UnicodeUTF8))
        self.pushButton_close.setText(QtWidgets.QApplication.translate("About", "Close", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_9.setText(QtWidgets.QApplication.translate("About", "Credits", None, QtWidgets.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtWidgets.QApplication.translate("About", "Write by", None, QtWidgets.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtWidgets.QApplication.translate("About", "Docummented by", None, QtWidgets.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QtWidgets.QApplication.translate("About", "Translated by", None, QtWidgets.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QtWidgets.QApplication.translate("About", "Art by", None, QtWidgets.QApplication.UnicodeUTF8))
        self.pushButton_license.setText(QtWidgets.QApplication.translate("About", "License", None, QtWidgets.QApplication.UnicodeUTF8))
        self.pushButton_close_2.setText(QtWidgets.QApplication.translate("About", "Close", None, QtWidgets.QApplication.UnicodeUTF8))
        self.pushButton_close_3.setText(QtWidgets.QApplication.translate("About", "Close", None, QtWidgets.QApplication.UnicodeUTF8))
        self.pushButton_about.setText(QtWidgets.QApplication.translate("About", "About", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_8.setText(QtWidgets.QApplication.translate("About", "License", None, QtWidgets.QApplication.UnicodeUTF8))
