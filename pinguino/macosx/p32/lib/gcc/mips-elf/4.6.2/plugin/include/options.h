...
enum opt_code
{
  ...
  OPT_mpaired_single = 1000,                 /* -mpaired-single */
  OPT_mplt = 1001,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1002,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1003,               /* -mrelax-pic-calls */
  OPT_mshared = 1004,                        /* -mshared */
  OPT_msingle_float = 1005,                  /* -msingle-float */
  OPT_msmartmips = 1006,                     /* -msmartmips */
  OPT_msoft_float = 1007,                    /* -msoft-float */
  OPT_msplit_addresses = 1008,               /* -msplit-addresses */
  OPT_msym32 = 1009,                         /* -msym32 */
  OPT_msynci = 1010,                         /* -msynci */
  OPT_mtune_ = 1011,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1012,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1013,                  /* -mvr4130-align */
  OPT_mxgot = 1014,                          /* -mxgot */
  OPT_n = 1015,                              /* -n */
  OPT_no_canonical_prefixes = 1016,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1017,              /* -no-integrated-cpp */
  OPT_noasmopt = 1018,                       /* -noasmopt */
  OPT_nocpp = 1019,                          /* -nocpp */
  OPT_nodefaultlibs = 1020,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1021,                   /* -nostartfiles */
  OPT_nostdinc = 1022,                       /* -nostdinc */
  OPT_nostdinc__ = 1023,                     /* -nostdinc++ */
  OPT_nostdlib = 1024,                       /* -nostdlib */
  OPT_o = 1025,                              /* -o */
  OPT_p = 1026,                              /* -p */
  OPT_pass_exit_codes = 1027,                /* -pass-exit-codes */
  OPT_pedantic = 1028,                       /* -pedantic */
  OPT_pedantic_errors = 1029,                /* -pedantic-errors */
  OPT_pg = 1030,                             /* -pg */
  OPT_pie = 1031,                            /* -pie */
  OPT_pipe = 1032,                           /* -pipe */
  OPT_print_file_name_ = 1033,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1034,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1035,          /* -print-multi-directory */
  OPT_print_multi_lib = 1036,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1037,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1038,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1039,               /* -print-prog-name= */
  OPT_print_search_dirs = 1040,              /* -print-search-dirs */
  OPT_print_sysroot = 1041,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1042,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1043,                          /* -quiet */
  OPT_r = 1044,                              /* -r */
  OPT_remap = 1045,                          /* -remap */
  OPT_s = 1046,                              /* -s */
  OPT_s_bc_abi = 1047,                       /* -s-bc-abi */
  OPT_save_temps = 1048,                     /* -save-temps */
  OPT_save_temps_ = 1049,                    /* -save-temps= */
  OPT_shared = 1050,                         /* -shared */
  OPT_shared_libgcc = 1051,                  /* -shared-libgcc */
  /* OPT_specs = 1052, */                    /* -specs */
  OPT_specs_ = 1053,                         /* -specs= */
  OPT_static = 1054,                         /* -static */
  OPT_static_libgcc = 1055,                  /* -static-libgcc */
  OPT_static_libgcj = 1056,                  /* -static-libgcj */
  OPT_static_libgfortran = 1057,             /* -static-libgfortran */
  OPT_static_libgo = 1058,                   /* -static-libgo */
  OPT_static_libstdc__ = 1059,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1060, */                /* -std=c++03 */
  OPT_std_c__0x = 1061,                      /* -std=c++0x */
  OPT_std_c__98 = 1062,                      /* -std=c++98 */
  OPT_std_c1x = 1063,                        /* -std=c1x */
  /* OPT_std_c89 = 1064, */                  /* -std=c89 */
  OPT_std_c90 = 1065,                        /* -std=c90 */
  OPT_std_c99 = 1066,                        /* -std=c99 */
  /* OPT_std_c9x = 1067, */                  /* -std=c9x */
  OPT_std_f2003 = 1068,                      /* -std=f2003 */
  OPT_std_f2008 = 1069,                      /* -std=f2008 */
  OPT_std_f95 = 1070,                        /* -std=f95 */
  OPT_std_gnu = 1071,                        /* -std=gnu */
  OPT_std_gnu__0x = 1072,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1073,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1074,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1075, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1076,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1077,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1078, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1079, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1080,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1081, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1082, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1083,                     /* -std=legacy */
  OPT_symbolic = 1084,                       /* -symbolic */
  OPT_t = 1085,                              /* -t */
  OPT_time = 1086,                           /* -time */
  OPT_time_ = 1087,                          /* -time= */
  OPT_traditional = 1088,                    /* -traditional */
  OPT_traditional_cpp = 1089,                /* -traditional-cpp */
  OPT_trigraphs = 1090,                      /* -trigraphs */
  OPT_u = 1091,                              /* -u */
  OPT_undef = 1092,                          /* -undef */
  OPT_v = 1093,                              /* -v */
  OPT_version = 1094,                        /* -version */
  OPT_w = 1095,                              /* -w */
  OPT_wrapper = 1096,                        /* -wrapper */
  OPT_x = 1097,                              /* -x */
  OPT_z = 1098,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
