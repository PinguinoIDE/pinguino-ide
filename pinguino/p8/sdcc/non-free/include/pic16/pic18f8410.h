/*
 * This declarations of the PIC18F8410 MCU.
 *
...
#ifndef __PIC18F8410_H__
#define __PIC18F8410_H__
...
#define _PM_EM_3L               0xFC    // Extended Microcontroller mode.
#define _PM_MPB_3L              0xFD    // Microprocessor with Boot Block mode.
#define _PM_MP_3L               0xFE    // Microprocessor mode.
#define _PM_MC_3L               0xFF    // Microcontroller mode.
#define _BW_8_3L                0xBF    // 8-bit External Bus Data Width.
#define _BW_16_3L               0xFF    // 16-bit External Bus Data Width.
#define _WAIT_ON_3L             0x7F    // Wait programmed by WAIT1 and WAIT0 bits of MEMCOM register (MEMCOM<5:4>).
#define _WAIT_OFF_3L            0xFF    // Wait selections unavailable, device will not wait.

//----------------------------- CONFIG3H Options -------------------------------

#define _CCP2MX_PORTBE_3H       0xFE    // CCP2 is multiplexed with RB3 in Extended Microcontroller, Microprocessor or Microprocessor with Boot Block mode. Or with RE7 in Microcontroller mode.
...
#define _CP_ON_5L               0xFE    // Program memory block code-protected.
#define _CP_OFF_5L              0xFF    // Program memory block not code-protected.

//----------------------------- CONFIG7L Options -------------------------------

#define _EBTR_ON_7L             0xFE    // Internal program memory block protected from table reads executed from external memory block.
#define _EBTR_OFF_7L            0xFF    // Internal program memory block not protected from table reads executed from external memory block.
