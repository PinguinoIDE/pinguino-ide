...
// Since right shifts under p32-gcc are always unsigned, the following
// preprocessor will need to be declared and set to 1
// otherwise the colors displayed will be wrong:
