...
void loop()
{
    ...
    if (f<100)
        ST7735.drawRect(SPIMODULE, x1, y1, x2, y2);
    else if (f<200)
        ST7735.drawRoundRect(SPIMODULE, x1, y1, x2, y2);
    else if (f<300)
        ST7735.fillRect(SPIMODULE, x1, y1, x2, y2);
    else if (f<400)
        ST7735.fillRoundRect(SPIMODULE, x1, y1, x2, y2);
