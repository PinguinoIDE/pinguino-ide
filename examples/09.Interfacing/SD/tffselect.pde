...
This demo is done in an interactive way thru a hyperterminal using CDC/USB mode.
...
// open file
      ...
      else if (*ptr == 'n') //fn <old name> <new name> rename
      {
          ...
          if (rc) die(rc);
          else CDC.printf("File %s renamed %s\r\n", bufname, ptr);
      }
